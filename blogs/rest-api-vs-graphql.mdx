...
|--------|----------|---------|
| Request count | 5-10 requests | 1 request |
| Data size | 100% (over-fetch) | 40-60% (exact) |
| Cache strategy | Easy (HTTP) | Complex (Apollo) |
...
|----------|------|---------|
| **Team expertise** | Beginner-friendly | Need learning |
| **Data complexity** | Simple/flat | Complex/nested |
| **Client variety** | Few clients | Multiple (web, mobile, IoT) |
| **Bandwidth concern** | Not critical | Critical |
| **Caching need** | High | Low-Medium |
| **Public API** | ✅ Better | Possible |
| **Real-time** | WebSockets | Subscriptions ✅ |
| **Development speed** | Fast start | Slower start, faster iteration |
